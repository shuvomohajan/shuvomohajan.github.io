  ...
  return (
    ...
    >
      <div className="container px-2 md:px-4 mx-auto h-full">
        <Image src="/shuvo.jpg" height="150" width="150" className="object-cover rounded-full" />
        ...
        <a href="#" className="mt-10 py-2.5 px-8 rounded-full font-bold bg-red-500 inline-block cursor-pointer">Hire Me</a>
      </div>
    </div>
  );
};
